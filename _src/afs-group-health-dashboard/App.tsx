      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <img 
              src="https://cdn.shopify.com/s/files/1/1950/1891/files/TheAFSGroup.png?v=1766395105" 
              alt="The AFS Group" 
              className="h-10 w-auto object-contain"
            />
            <div className="h-8 w-[1px] bg-gray-300 hidden md:block"></div>
            <h1 className="text-xl font-bold text-brand-navy hidden md:block">Performance Dashboard</h1>
          </div>
