...
// Published-to-web copy of "AFS Group - One Page Plan (For Scoreboard)".
...
// Deliberately EMPTY. A populated fallback renders identically to live data, so a
// proxy outage would look like a healthy plan. Empty plus the "cached snapshot" badge
// makes the failure visible instead.
const FALLBACK: OpspData = {
    period: "unavailable",
    quarterLabel: "",
    coreValues: [], purpose: "", bhag: "", bhagTargets: [],
    brandPromises: [], brandPromiseKpis: [],
    horizonYear: "", horizonRevenue: "", keyThrusts: [], profitX: "",
    fy27Revenue: "", fy27GrossProfit: "", fy27GPMargin: "",
    initiatives: [], actions: [],
    strengths: [], weaknesses: [], opportunities: [], threats: [],
    criticalNumbers: [], theme: [], people: [], process: [], sandbox: [],
};
    ...
    if (isLoading || !data) {
        return (
            <div className="flex flex-col items-center justify-center h-screen gap-4">
                ...
                <p className="text-gray-500 font-medium">Loading One Page Plan...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-[#f8f8fa] font-sans pb-20 animate-in fade-in duration-500">
            ...
            <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
                ...
                {/* No Trend Detail block here: those were Revel's brand-specific
                    recovery and margin series, which have no Group equivalent. */}
