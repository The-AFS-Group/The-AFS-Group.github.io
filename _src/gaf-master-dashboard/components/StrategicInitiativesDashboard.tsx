...
async function fetchAsanaInitiatives(): Promise<{ tasks: any[]; sprintOptions: string[] }> {
    ...
    const tasksRes = await fetch(`${ASANA_PROXY}/sections/${gafSection.gid}/tasks?opt_fields=name,completed,due_on,assignee.name,permalink_url,custom_fields,custom_fields.name,custom_fields.display_value,custom_fields.enum_options,parent,parent.name`);
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-center min-w-[180px]">
                                    ...
                                    {isCurrentSprint && (
                                        <div className="text-[10px] font-bold text-orange-600 uppercase tracking-widest">Current Quarter</div>
                                    )}
                                </div>
                                <button
