...
const DOC_PUB_URL =
    "https://docs.google.com/document/d/e/2PACX-1vQaqKIXJyNpXMTelK26-oBh4fhHWH1zNCl3nBkHmBdWCYnL0jO2StVI3MGQ0WI8Pr-JdAxDuevuyskT/pub";
...
const FALLBACK: OpspData = {
    ...
    bhag: "By 2031 Help 100,000 people to make wellness part of everyday life.",
    bhagTargets: ["10k Homes", "500 Commercial Businesses", "2500 complete Feel Better Program"],
    brandPromises: [
        "Feel Better or we buy back your wellness product",
        "Improve Health and Wellness Every Day",
        "Exceptional Guided Experience",
    ],
    brandPromiseKpis: [],
    horizonYear: "FY31",
    horizonRevenue: "$32,000,000",
    keyThrusts: [],
    profitX: "Contribution Margin per Order (Revenue - COGS - Freight, Returns - CAC)",
    fy27Revenue: "$14,700,000",
    fy27GrossProfit: "$6,200,000",
    fy27GPMargin: "42%",
    initiatives: [],
    actions: [],
